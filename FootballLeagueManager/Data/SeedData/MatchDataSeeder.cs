...
public class MatchDataSeeder : ISeeder
{
    ...
    private readonly List<Match> _matches = new()
    {
        ...
        new Match
        {
            ...
            HomeTeamGoals = 2,
            AwayTeamGoals = 1,
            Date = new DateTime(2023, 5, 22, 17, 00, 0),
            Queue = 1,
            HomeTeamId = 21,
            AwayTeamId = 22,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 1,
            AwayTeamGoals = 3,
            Date = new DateTime(2023, 5, 22, 13, 00, 0),
            Queue = 1,
            HomeTeamId = 23,
            AwayTeamId = 21,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 1,
            AwayTeamGoals = 0,
            Date = new DateTime(2023, 4, 22, 11, 00, 0),
            Queue = 1,
            HomeTeamId = 22,
            AwayTeamId = 23,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 1,
            AwayTeamGoals = 3,
            Date = new DateTime(2023, 5, 22, 19, 00, 0),
            Queue = 1,
            HomeTeamId = 24,
            AwayTeamId = 22,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 3,
            AwayTeamGoals = 1,
            Date = new DateTime(2023, 6, 22, 17, 00, 0),
            Queue = 1,
            HomeTeamId = 23,
            AwayTeamId = 24,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 5,
            AwayTeamGoals = 2,
            Date = new DateTime(2023, 5, 23, 17, 00, 0),
            Queue = 2,
            HomeTeamId = 25,
            AwayTeamId = 23,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 2,
            AwayTeamGoals = 0,
            Date = new DateTime(2023, 5, 11, 17, 00, 0),
            Queue = 1,
            HomeTeamId = 24,
            AwayTeamId = 25,
            SeasonId = 4
        ...
        new Match
        {
            ...
            HomeTeamGoals = 1,
            AwayTeamGoals = 3,
            Date = new DateTime(2023, 11, 11, 18, 15, 0),
            Queue = 1,
            HomeTeamId = 27,
            AwayTeamId = 26,
            SeasonId = 4
